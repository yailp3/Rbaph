###########################################################################
## Makefile generated for component 'joystick_to_force_mocap'. 
## 
## Makefile     : joystick_to_force_mocap.mk
## Generated on : Thu Sep 11 15:37:11 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/joystick_to_force_mocap.elf
...
PRODUCT_NAME              = joystick_to_force_mocap
MAKEFILE                  = joystick_to_force_mocap.mk
...
START_DIR                 = $(MATLAB_WORKSPACE)/D/Bureau/stage/Matlab/Rbaph_calculs
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/joystick_to_force_mocap.elf
...
%.c.o : $(START_DIR)/joystick_to_force_mocap_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/joystick_to_force_mocap_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/joystick_to_force_mocap_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/joystick_to_force_mocap_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


joystick_to_force_mocap.c.o : $(START_DIR)/joystick_to_force_mocap_ert_rtw/joystick_to_force_mocap.c
	$(CC) $(CFLAGS) -o "$@" "$<"


joystick_to_force_mocap_data.c.o : $(START_DIR)/joystick_to_force_mocap_ert_rtw/joystick_to_force_mocap_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.c.o : $(START_DIR)/joystick_to_force_mocap_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.c.o : $(START_DIR)/joystick_to_force_mocap_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.c.o : $(START_DIR)/joystick_to_force_mocap_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
