...
void to_point_minE_step(void)
{
  ...
  if (to_point_minE_B.SFunctionBuilder_o2[0] > 0.0) {
     ...
     *  SignalConversion generated from: '<S7>/p1'
     *  SignalConversion generated from: '<S7>/p2'
     */
    to_point_minE_B.Merge[0] = to_point_minE_B.SignalConversion[0];
    to_point_minE_B.Merge[1] = to_point_minE_B.SignalConversion[1];
    to_point_minE_B.Merge[2] = to_point_minE_P.Constant_Value;
     ...
     */
    to_point_minE_B.Merge[0] = to_point_minE_P.Constant_Value_n;
    to_point_minE_B.Merge[1] = to_point_minE_B.SignalConversion[1];
...
void to_point_minE_initialize(void)
{
  ...
  /* External mode info */
  to_point_minE_M->Sizes.checksums[0] = (3747254502U);
  to_point_minE_M->Sizes.checksums[1] = (410389483U);
  to_point_minE_M->Sizes.checksums[2] = (1585991183U);
  to_point_minE_M->Sizes.checksums[3] = (3287756020U);
